<?php
	...
	$file = fopen('imports/WB-Clients.csv', 'r');
	...
	foreach ($clients as $client)
	{
		...
		if ($client['nom'] != '')
		{
			...
			//Insertion du client
			$req = "insert into wb_clients (id, id_type, id_statut, id_departement, id_zone, date, nom, activite, adresse, cp, ville, arguments, capital, societecom, site1, site2, site3, site4, flyer, relance, maj) values (
'".mysqli_escape_string($sql_link, ($client['vide']+1000))."',
